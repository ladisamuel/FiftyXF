...
export default function Hero() {
  return (
    <div className='h-[70vh] lg:h-[90vh] px-5  bg-blue300 flex items-center justify-center '>
        ...
        <div className=' lg:w-[70%] textcenter relative'>
            ...
            <img src={img5} className='absolute bottom-0 right-2 lg:right-40 translate-y-1/2 w-10 md:w-auto lg:w-auto' />
            <div className='flex flex-col items-center justify-center gap-y-10 gap-5 text-center'>
                <p className='border border-[#9F9F9F] flex items-center gap-3 text-xs md:text-lg lg:text-lg px-[31px] py-2 rounded-full w-fit '><p>Welcome to fiftyX Crypto Platform</p> <img src={partypopper} alt="" /> </p>
                ...
                <button className='py-[15px] px-[49px] rounded-full text-white bg-[#2394E5] '>Get Started</button>
            </div>
